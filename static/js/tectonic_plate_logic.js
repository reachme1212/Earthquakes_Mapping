...
// Then we add a control to the map that will allow the user to change layers.
L.control.layers(baseMaps, overlays).addTo(map);

// Retrieve the earthquake GeoJSON data.
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {

    // This function determines the style of the marker based on the magnitude of the earthquake.
    ...
    // This function determines the size of the marker based on the magnitude of the earthquake.
